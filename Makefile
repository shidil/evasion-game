...
ifeq ($(PLATFORM),PLATFORM_WEB)
    ...
    LDLIBS = libs/libraylib.web.a
endif

# Define all source files required
PROJECT_SOURCE_FILES ?= \
    src/game.cc \
    src/screens/screen_logo.cc \
    src/screens/screen_title.cc \
    src/screens/screen_options.cc \
    src/screens/screen_gameplay.cc \
    src/screens/screen_ending.cc

# Define all object files from source files
OBJS = $(patsubst %.cc, %.o, $(PROJECT_SOURCE_FILES))
...
$(PROJECT_NAME): $(OBJS)
	$(CC) -o build/$(PROJECT_NAME)$(EXT) $(PROJECT_SOURCE_FILES) $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM)
