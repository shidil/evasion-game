...
inline void draw_player(Player player) {
  ...
  DrawPolyLines(player.position, 8, PLAYER_RADIUS + 2 , player_rotation, { 255, 255, 255, 100});
  DrawPolyLines(player.position, 8, PLAYER_RADIUS + 3 , player_rotation, { 255, 255, 255, 50});
  DrawPolyLines(player.position, 8, PLAYER_RADIUS + 4 , player_rotation, { 255, 255, 255, 10});
